...
function BeerDetailsPage() {
  ...
  const getData = async () => {
    try {
      setIsLoading(true)
      // console.log("Testing getting data from single beer");
      const singleBeerResponse = await axios.get(`https://ih-beers-api2.herokuapp.com/beers/${beerId}`)
      // console.log(singleBeerResponse.data);
      setBeer(singleBeerResponse.data);
      setIsLoading(false)
    } catch (error) {
      setIsLoading(true)
      console.log(error);
